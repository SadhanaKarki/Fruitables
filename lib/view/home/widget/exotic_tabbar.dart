...
class ExoticTabbar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     ...
     List<Product> exoticProducts =
        productList.where((product) => product.category == "exotic").toList();
    return GridView.builder(
      ...
      itemCount: exoticProducts.length, 
      itemBuilder: (context, index) {
        return CardSample(product: exoticProducts[index]);
      },
    );
  }
}
